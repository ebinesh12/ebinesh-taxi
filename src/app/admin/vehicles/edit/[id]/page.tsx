...
export default function EditVehiclePage() {
  ...
  const [service_type, setServiceType] = useState<"One-Way" | "Round-Trip">("One-Way");
  ...
  const handleUpdate = async (formData: FormData) => {
    ...
    if (result?.error) {
      ...
      router.push("/dashboard/vehicles"); // Redirect to the list page after success
    }
  };
  ...
  return (
    <div className="p-4 sm:p-8 max-w-3xl mx-auto">
      <Card>
        <CardHeader>
          <CardTitle className="text-3xl text-center font-bold">Edit Vehicle</CardTitle>
          <CardDescription className="text-center">
            Update the details for <span className="font-bold">{vehicle.name}</span>.
          </CardDescription>
        </CardHeader>
